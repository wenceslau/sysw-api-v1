...
import com.suite.core.listener.CoreChangeListener;
 ...
 */
@MappedSuperclass
@EntityListeners(CoreChangeListener.class)
public class ModelCore extends Model {
