CREATE TABLE tb_core_data_service (
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbCoreDataService PRIMARY KEY,
...
CREATE TABLE tb_core_property (
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbCoreProperty PRIMARY KEY,
