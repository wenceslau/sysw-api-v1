CREATE TABLE tb_core_data_list(
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbCoreDataList PRIMARY KEY,	
	nam_list VARCHAR(50),
	sts_record BIT NOT NULL
);

CREATE TABLE tb_core_item_data_list(
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbCoreItemDataList PRIMARY KEY,
