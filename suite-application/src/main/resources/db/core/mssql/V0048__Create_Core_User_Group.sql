...
CREATE TABLE tb_core_user_group (
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbCoreUserGroup PRIMARY KEY,
...
CREATE TABLE tb_core_user_group_user (
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbCoreUserGroupUser PRIMARY KEY,
