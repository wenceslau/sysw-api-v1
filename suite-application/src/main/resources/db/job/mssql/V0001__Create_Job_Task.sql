CREATE TABLE tb_job_task (
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbJobTask PRIMARY KEY,
...
CREATE TABLE tb_job_task_property (
	cod_record BIGINT IDENTITY(1,1) NOT NULL CONSTRAINT pk_tbJobTaskProperty PRIMARY KEY,
